...
-- SQLite. See README.md in this folder for context and verification queries.
--
...
-- Both statements are idempotent (INSERT OR IGNORE on the primary key).
...
INSERT OR IGNORE INTO go_container_template_spec
...
INSERT OR IGNORE INTO go_container_template_definition
